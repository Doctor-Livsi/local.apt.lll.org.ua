<div class="nav-content d-flex">
    ...
    <div class="language-switch-container">
        <button class="btn btn-empty language-button dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" readonly>UA</button>
        <div class="dropdown-menu">
            <a href="#" class="dropdown-item active">UA</a>
...
{{--            <img class="profile" alt="profile" src="/img/profile/profile-9.webp" />--}}
            ...
            @php
                // Перевіряємо доступ до first_name і last_name
                ...
                // Якщо ініціали порожні, використовуємо першу літеру з name як запасний варіант
//                $initials = strtoupper(substr(Auth::user()->first_name, 0, 1)) ;
            @endphp
            <div class="user-initials" style="background-color: #3f4a53; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                {{ $initials }}
            </div>
        </a>
...
{{--        </li>--}}
    ...
    <div class="menu-container flex-grow-1">
        @include('_layout.partials.menu-item')
    </div>
    <!-- Menu End -->
