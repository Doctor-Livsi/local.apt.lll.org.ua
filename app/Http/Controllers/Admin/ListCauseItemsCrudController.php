...
use App\Models\Admin\ListCauseItems;

class ListCauseItemsCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Admin\ListCauseItems::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/list-cause-items');
        CRUD::setEntityNameStrings('Причина', 'Список Cause');
